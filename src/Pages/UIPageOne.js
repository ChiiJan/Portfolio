                            ...
                            <div className='design-process'>
                                ...
                                <Accordion sx={{ borderRadius: 2, p: 1, mb: 2, mt: 2 }}>
                                    ...
                                    <AccordionDetails>
                                        ...
                                        <div className='image-content'>
                                            ...
                                            <img src={require('../assets/arrow-old.png')} alt="arrow" />
                                            <img src={require('../assets/Splash-page-new.png')} alt="Splash Page Redesigned Version" />
                                            <img src={require('../assets/arrow-new.png')} alt="arrow" />
                                        </div>
                                    </AccordionDetails>
                                </Accordion>
                                ...
                                <Accordion sx={{ borderRadius: 2, p: 1, mb: 2 }}>
                                    ...
                                    For a mobile design, it’s important that the call-to-action buttons and text are appropriately sized to ensure a clean and user-friendly interface.
                                        ...
                                        <div className='image-content'>
                                            <img src={require('../assets/Login-page-old.png')} alt="Welcome Page Old Version" />
                                            <img src={require('../assets/arrow-old.png')} alt="arrow" />
                                            <img src={require('../assets/Login-page-new.png')} alt="Welcome Page Redesigned Version" />
                                            <img src={require('../assets/arrow-new.png')} alt="arrow" />
                                        </div>
                                    </AccordionDetails>
